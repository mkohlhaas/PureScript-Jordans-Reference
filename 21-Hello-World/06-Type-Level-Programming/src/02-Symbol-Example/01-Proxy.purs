...
printOrdering ∷ ∀ a. Reflectable a Ordering ⇒ String → Proxy a → Effect Unit
printOrdering subhead ord = printLine subhead $ show $ reflectType ord

printSymbol ∷ ∀ a. Reflectable a String ⇒ String → Proxy a → Effect Unit
