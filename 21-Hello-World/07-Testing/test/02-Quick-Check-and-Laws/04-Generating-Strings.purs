...
main =
  ...
  printData "explanation" $
    ...
    printData
      "genUnicodeChar - generates a character of the Unicode basic \
    ...
    printData
      "genAsciiChar - generates a character in the ASCII character set, \
    ...
    printData
      "genAlphaLowercase - generates a lowercase character from the \
      \basic latin alphabet" $
      genAlphaLowercase

    printData
      "genAlphaUppercase - generates an uppercase character from the \
      \basic latin alphabet" $
      genAlphaUppercase
    ...
    printData
      "custom Char generator - generates a character between the 65 \
    ...
    printData
      "genUnicodeString - generates a 1-character String of the Unicode \
    ...
    printData
      "genAsciiString - generates a 1-character String in the ASCII \
    ...
    printData
      "genDigitString - generates a 1-character String that is a \
      \numeric digit" $
      genDigitString

    printData
      "genAlpha - generates a 1-character String from the basic latin \
      \alphabet" $
      genAlphaString

    printData
      "genAlphaLowercase - generates a lowercase 1-character String from \
      \the basic latin alphabet" $
      genAlphaLowercaseString

    printData
      "genAlphaUppercase - generates an uppercase 1-character String \
      \from the basic latin alphabet" $
      genAlphaUppercaseString

    printData
      "custom String generator - generates a 1-character String using \
...
printData ∷ ∀ a. Show a ⇒ String → Gen a → Effect Unit
printData explanation generator = do
  log $ "=== " <> explanation
  result ← randomSample generator
  forWithIndex_ result
    ( \index item →
