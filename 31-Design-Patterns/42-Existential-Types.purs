...
mkData ∷ ∀ a b. ActualDataTypeUsedInThisProject a b → ExposedDataTypeUsedByEndDevelopers Int a
mkData = unsafeCoerce

unData
  ∷ ∀ exposed r
  . (∀ hidden. ActualDataTypeUsedInThisProject exposed hidden → r)
  → ExposedDataTypeUsedByEndDevelopers Int exposed
  → r
unData = unsafeCoerce

changePrivateData ∷ ∀ a. (NonPublicState → NonPublicState) → ExposedDataTypeUsedByEndDevelopers Int a
