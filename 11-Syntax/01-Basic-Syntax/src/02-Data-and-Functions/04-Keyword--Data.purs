...
data Singleton_with_Function_Arg = SingletonConstructor3 (ParameterType → ReturnType)
...
data Type_With_HigherKindedByTwo_Generic higherKindedBy2 a b = Example (higherKindedBy2 a b)
