...
else instance ExampleClass2 Type2
else instance ExampleClass2 Type3
...
instance ProduceAnInt Int where
  mkInt theInt = theInt
else instance ProduceAnInt String where
  mkInt _ = 13
else instance ProduceAnInt SomeRandomType where
  mkInt FirstValue = 89
  mkInt SecondValue = 98
else instance ProduceAnInt allOtherPossibleTypes where
  mkInt _ = 42
...
instance (Show allPossibleTypes) ⇒ Stringify allPossibleTypes where
  stringify a = show a
else instance Stringify a where
