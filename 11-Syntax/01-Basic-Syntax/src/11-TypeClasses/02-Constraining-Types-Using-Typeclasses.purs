...
stringList_to_intList ∷ ∀ a. ToInt a ⇒ List a → List Int
...
function0 ∷ ∀ a b. TypeClass1 a ⇒ TypeClass2 b ⇒ a → b → String
...
instance
  ...
  (TypeClassN a) => -}
  TypeClass1 (IntanceType a) where
  function1 _ = "body"
