...
outerFunction ∷ ∀ a b. a → b → String
outerFunction aVal bVal = returnSecond (returnFoo @a aVal) (returnFoo @b bVal)
  where
  returnFoo ∷ ∀ @x. x → String
  returnFoo _x = "foo"

  returnSecond ∷ ∀ first second. first → second → first
