...
-- Example
type ComplexFunction = Int → (∀ a b. a → (∀ c. c → b) → b)
...
example ∷ ∀ a. a → ConvertAToString a → String
...
type ConvertBToString2 = ∀ b. b → String

bToString1 ∷ ∀ b. b → ConvertBToString1 b → String
bToString1 value toString = toString value

bToString2 ∷ ∀ b. b → ConvertBToString2 → String {-
