...
hktFunction1 ∷ ∀ f g h a. f a → g a → h a → h a
...
hktFunction2 ∷ ∀ f a b c d. f a b c d → f a b c d
...
hktFunction3 ∷ ∀ f a b c. f a b c Int → f a b c Int
...
boxFunction ∷ ∀ f a. f a → (f a → a) → (a → a) → (a → f a) → f a
...
unwrapBox2 ∷ ∀ a. Box2 a → a
unwrapBox2 (Box2 a) = a

unwrapBox3 ∷ ∀ a. Box3 a → a
unwrapBox3 (Box3 a) = a

rewrapBox2 ∷ ∀ a. a → Box2 a
rewrapBox2 a = Box2 a

rewrapBox3 ∷ ∀ a. a → Box3 a
rewrapBox3 a = Box3 a
